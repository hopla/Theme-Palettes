namespace Krypton.Toolkit.Themes
{
    ...
    /// </summary>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(KryptonPaletteExtended), "ToolboxBitmaps.KryptonPalette.bmp")]
    [DefaultEvent("PalettePaint")]
    [DefaultProperty("BasePaletteMode")]
    [DesignerCategory(@"code")]
    [Designer("Krypton.Toolkit.Themes.KryptonPaletteExtendedDesigner, Krypton.Toolkit.Themes")]
    [Description(@"A customisable palette component.")]
    public class KryptonPaletteExtended : Component, IPalette
    {
        ...
        private PaletteModeExtended _basePaletteMode;
        ...
        /// </summary>
        public KryptonPaletteExtended()
        {
            // Setup the need paint delegate
            _needPaintDelegate = OnNeedPaint;

            // Set the default palette/palette mode
            _basePalette = KryptonManager.GetPaletteForMode(PaletteModeExtended.Office365Blue);
            _basePaletteMode = PaletteModeExtended.Office365Blue;
        ...
        public KryptonPaletteExtended(IContainer container)
            : this()
        {
        ...
        [DefaultValue(typeof(PaletteModeExtended), "Office365Blue")]
        public PaletteModeExtended BasePaletteMode
        {
                ...
                if (_basePaletteMode != value)
                {
                    ...
                    switch (value)
                    {
                        ...
                        default:
                            ...
                            PaletteModeExtended tempMode = _basePaletteMode;
        ...
        private bool ShouldSerializeBasePaletteMode() => BasePaletteMode != PaletteModeExtended.Office365Blue;

        private void ResetBasePaletteMode() => BasePaletteMode = PaletteModeExtended.Office365Blue;
        ...
        public IPalette BasePalette
        {
            ...
            set
            {
                ...
                if (_basePalette != value)
                {
                    ...
                    _basePaletteMode = value == null ? PaletteModeExtended.Office365Blue : PaletteModeExtended.Custom;
                    _basePalette = value;
                ...
                else
                {
                    ...
                    if (palette is KryptonPaletteExtended owner)
                    {
                        ...
                        palette = owner.BasePaletteMode switch
                        {
                            ...
                            PaletteModeExtended.Global => KryptonManager.InternalGlobalPalette,
                            _ => null
                        };
                    }
                    else
...
#pragma warning restore SYSLIB0011
        ...
        static readonly Dictionary<Type, string> _typeTests = new()
        {
            ...
            [typeof(PaletteModeExtended)] = nameof(PaletteModeExtended),
